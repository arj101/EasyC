...
pub trait Visit<'ast> {
    ...
    fn visit_sum_type_builder(&mut self, _: &'ast SumTypeBuilder, span: &'ast Span) {
    ...
    fn visit_if_let(&mut self, f: &'ast IfLetStatement, span: &'ast Span) {
    ...
    fn visit_if_expr(&mut self, extension: &'ast IfExpr, span: &'ast Span) {
